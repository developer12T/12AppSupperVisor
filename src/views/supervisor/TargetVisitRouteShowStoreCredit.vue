<template>
  <div class="p-6 bg-gray-50">
    ...
    <button class="btn btn-success" @click="goToLineCheckinCredit">
      ดู Line การเช็คอินรวม
    </button>
    <div
      class="overflow-x-auto rounded-xl mt-5"
      style="
        min-height: 450px;
        max-height: 450px;
        max-width: 90vw;
...
onMounted(async () => {
  ...
  await routeStore.getStoreCheckinByDayAreaCredit(
    route.params.area,
    route.params.date,
  );
